...
public class JsonFiltro implements Filter {
    ...
    private void doBeforeProcessing(ServletRequest request, ServletResponse response)
        ...
        String apikey = ((HttpServletRequest) request).getHeader("Api");
        if (apikey.equals("dentro")) {
            ...
            if (cliente != null && !cliente.isEmpty()) {
                Cliente a = mapper.readValue(cliente, new TypeReference<Cliente>() {
                });
                request.setAttribute("cliente", a);
            }

            if (producto != null && !producto.isEmpty()) {
                Producto a = mapper.readValue(producto, new TypeReference<Producto>() {
                });
